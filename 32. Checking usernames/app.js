...
*/
// Step # 1: Arrays
const currentusernames = ["Sahifa", "Fazila", "Tayyab", "Moon", "Yasmeen", "Shakil"];
const new_users = ["Ayesha", "Malaika", "Sahifa", "Fazila", "Azwa", "Naira"];
// Step # 2: Function
function checkUserNames(currentusernames, new_users) {
